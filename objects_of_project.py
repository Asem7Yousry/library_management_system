...
class Book(Category):
    #### constructor of object ####
    def __init__(self,title,auther,number_pages,published_date,category_title,hint,number_copies,borrowing_price,buying_price,is_valid=True):
        self.title = title
        self.auther = auther
...
# novel1 = Book("dark",'asem','125','1999-05-20','horror','bjdbcisajl',5,20,50)

# osama = Reader('osama',2548564185)
# print(osama.id)

# transaction1 =  Transaction(osama.name,novel1.title)

# print(novel1.title)
# print(osama.id)
# print(transaction1.id)
# print(transaction1.title)
# print(osama.date_of_end_joining)
